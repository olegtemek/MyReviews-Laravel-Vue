            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  @endif
                  <input type="text" class="form-control" id="name_ru" value="{{old('name_ru')}}" placeholder="Enter name_ru" name="name_ru">
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  @endif
                  <input type="text" class="form-control" id="video" value="{{old('video')}}" placeholder="Enter video url" name="video">
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  @endif
                  <textarea name="description_ru" class="form-control" id="description_ru">{{old('description_ru')}}</textarea>
                </div>
              </div>
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <div class="row col-sm">
                    ...
                    <input type="text" id="sound" name="sound" value="{{ old('sound') }}">
